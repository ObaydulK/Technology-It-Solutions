            ...
            <div>
                <footer className="footer p-10 ">
                    <aside>
                        ...
                        <h1>Technology</h1>
                        <p>At Technology, we offer affordable and <br /> comprehensive range of IT solutions services, <br /> that empower drive growth, and enhance efficiency.</p>
                        <div>
                    ...
                    <nav>
                        <header className="footer-title">Help Center</header>
                    ...
                    <nav>
                        ...
                        <a className="link link-hover">User Interface Design</a>
